...
import (
	...
	externalRef6 "terraform-provider-render/internal/client/jobs"
	externalRef7 "terraform-provider-render/internal/client/logs"
	externalRef8 "terraform-provider-render/internal/client/maintenance"
	externalRef9 "terraform-provider-render/internal/client/metrics"
	externalRef10 "terraform-provider-render/internal/client/notifications"
	externalRef11 "terraform-provider-render/internal/client/postgres"
...
type TaskWithCursor struct {
	Cursor Cursor             `json:"cursor"`
	Task   externalRef13.Task `json:"task"`
}
...
type ListTaskRunsParams struct {
	...
	TaskId *externalRef13.TaskIdFilterParam `form:"taskId,omitempty" json:"taskId,omitempty"`

	// RootTaskRunId An array of root task IDs to filter on
	RootTaskRunId *externalRef13.RootTaskRunIDFilterParam `form:"rootTaskRunId,omitempty" json:"rootTaskRunId,omitempty"`

	// OwnerId The ID of the workspaces to return resources for
	OwnerId *OwnerIdParam `form:"ownerId,omitempty" json:"ownerId,omitempty"`

	// WorkflowVersionId An array of workflow version IDs
	WorkflowVersionId *externalRef13.WorkflowVersionIDFilterParam `form:"workflowVersionId,omitempty" json:"workflowVersionId,omitempty"`

	// WorkflowId An array of workflow IDs
	WorkflowId *externalRef13.WorkflowIDFilterParam `form:"workflowId,omitempty" json:"workflowId,omitempty"`
}
...
type ListWebhookEventsParams struct {
	...
	SentBefore *externalRef12.SentBeforeParam `form:"sentBefore,omitempty" json:"sentBefore,omitempty"`

	// SentAfter Filter for resources sent after a certain time (specified as an ISO 8601 timestamp)
	SentAfter *externalRef12.SentAfterParam `form:"sentAfter,omitempty" json:"sentAfter,omitempty"`
...
type CreateTaskJSONRequestBody = externalRef13.RunTask

// CreateWebhookJSONRequestBody defines body for CreateWebhook for application/json ContentType.
type CreateWebhookJSONRequestBody = externalRef12.WebhookPOSTInput

// UpdateWebhookJSONRequestBody defines body for UpdateWebhook for application/json ContentType.
type UpdateWebhookJSONRequestBody = externalRef12.WebhookPATCHInput

// CreateWorkflowJSONRequestBody defines body for CreateWorkflow for application/json ContentType.
type CreateWorkflowJSONRequestBody = externalRef13.WorkflowCreate

// UpdateWorkflowJSONRequestBody defines body for UpdateWorkflow for application/json ContentType.
type UpdateWorkflowJSONRequestBody = externalRef13.WorkflowUpdate

// CreateWorkflowVersionJSONRequestBody defines body for CreateWorkflowVersion for application/json ContentType.
type CreateWorkflowVersionJSONRequestBody = externalRef13.CreateVersion
