...
type GetOwnerLogsStreams200Response = externalRef5.OwnerLogStreamSetting

// GetResourceLogsStreams200Response Resource log stream overrides
type GetResourceLogsStreams200Response = externalRef5.ResourceLogStreamSetting
...
type ResourceLogsStreams200Response = []externalRef5.ResourceLogStreamSetting
...
// UpdateOwnerLogStreamParams defines parameters for UpdateOwnerLogStream.
type UpdateOwnerLogStreamParams struct {
	// Endpoint The endpoint to stream logs to.
	Endpoint *externalRef5.LogStreamEndpoint `form:"endpoint,omitempty" json:"endpoint,omitempty"`

	// Token The optional token to authenticate the log stream.
	Token *externalRef5.LogStreamToken `form:"token,omitempty" json:"token,omitempty"`

	// Preview Whether to stream logs from PR previews or preview environments.
	Preview externalRef5.LogStreamPreview `form:"preview" json:"preview"`
}
...
// UpdateResourceLogStreamParams defines parameters for UpdateResourceLogStream.
type UpdateResourceLogStreamParams struct {
	// Endpoint The endpoint to stream logs to.
	Endpoint *externalRef5.LogStreamEndpoint `form:"endpoint,omitempty" json:"endpoint,omitempty"`
	...
	Setting externalRef5.LogStreamSetting `form:"setting" json:"setting"`
}
