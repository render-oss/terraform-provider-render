...
func TestPrivateServiceResource(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		ProtoV6ProviderFactories: th.SetupRecordingProvider(t, "private_service_cassette"),
		Steps: []resource.TestStep{
			{
				ResourceName: resourceName,
				ConfigFile:   config.StaticFile("./testdata/everything_enabled.tf"),
				ConfigVariables: config.Variables{
					"name":                   config.StringVariable("private-service-tf"),
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "name", "private-service-tf"),
					...
					resource.TestCheckResourceAttrWith(resourceName, "slug", func(value string) error {
						if !strings.HasPrefix(value, "private-service-tf") {
...
func TestPrivateServiceScalingResource(t *testing.T) {
	resourceName := "render_private_service.private"
...
func TestPrivateServiceNotificationsResource(t *testing.T) {
	resourceName := "render_private_service.private"
...
func TestPrivateServiceDiskResource(t *testing.T) {
	resourceName := "render_private_service.private"
...
func TestPrivateServiceGitConfigResource(t *testing.T) {
	resourceName := "render_private_service.private"
...
func TestPrivateServiceDockerResource(t *testing.T) {
	resourceName := "render_private_service.private"
...
func TestEnvVarsResource(t *testing.T) {
	resourceName := "render_private_service.service"
